package me.defender.cosmetics.api.category.islandtoppers.items;

import com.sk89q.worldedit.MaxChangedBlocksException;
import me.defender.cosmetics.api.category.islandtoppers.IslandTopper;
import me.defender.cosmetics.api.category.islandtoppers.util.IslandToppersUtil;
        ...
        for(String id : topperSection.getKeys(false)){
            ...
            IslandTopper islandTopper = new IslandTopper() {
                ...
                public void execute(Player player, Location topperLocation, String selected) {
                    ...
                    File file = new File(Utility.plugin().getDataFolder().getPath() + "/IslandToppers/" + fileName);
                    if(!file.exists()){
