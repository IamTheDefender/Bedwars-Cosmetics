...
public class FinalKillEffectData
{
    private final Main plugin;
    private FileConfiguration datacfg;
    private File cfgfile;

    public FinalKillEffectData(final Main plugin) {
        this.plugin = plugin;
        this.savedefaultcfg();
    }
    ...
    public void reloadcfg() {
        if (this.cfgfile == null) {
            this.cfgfile = new File(this.plugin.getDataFolder(), "FinalKillEffects.yml");
        }
        this.datacfg = YamlConfiguration.loadConfiguration(this.cfgfile);
        final InputStream defaultStream = this.plugin.getResource("FinalKillEffects.yml");
    ...
    public void savedefaultcfg() {
        ...
        if (!this.cfgfile.exists()) {
            this.plugin.saveResource("FinalKillEffects.yml", false);
        }
    }
}
