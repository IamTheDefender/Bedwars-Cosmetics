...
public class BedBreakEffectData
{
    private final Main plugin;
    private FileConfiguration datacfg;
    private File cfgfile;
    
    public BedBreakEffectData(final Main plugin) {
        this.plugin = plugin;
        this.savedefaultcfg();
    }
    ...
    public void reloadcfg() {
        if (this.cfgfile == null) {
            this.cfgfile = new File(this.plugin.getDataFolder(), "BedBreakEffects.yml");
        }
        this.datacfg = YamlConfiguration.loadConfiguration(this.cfgfile);
        final InputStream defaultStream = this.plugin.getResource("BedBreakEffects.yml");
    ...
    public void savedefaultcfg() {
        ...
        if (!this.cfgfile.exists()) {
            this.plugin.saveResource("BedBreakEffects.yml", false);
        }
    }
}
