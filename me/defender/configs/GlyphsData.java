...
public class GlyphsData
{
    ...
    public GlyphsData(final Main plugin) {
        this.plugin = plugin;
        this.savedefaultcfg();
    }
    ...
    public void reloadcfg() {
        if (this.cfgfile == null) {
            this.cfgfile = new File(this.plugin.getDataFolder(), "Glyphs.yml");
        }
        this.datacfg = YamlConfiguration.loadConfiguration(this.cfgfile);
        final InputStream defaultStream = this.plugin.getResource("Glyphs.yml");
    ...
    public void savedefaultcfg() {
        ...
        if (!this.cfgfile.exists()) {
            this.plugin.saveResource("Glyphs.yml", false);
        }
    }
}
