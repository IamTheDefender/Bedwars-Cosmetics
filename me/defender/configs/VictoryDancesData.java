...
public class VictoryDancesData
{
    private final Main plugin;
    private FileConfiguration datacfg;
    private File cfgfile;
    
    public VictoryDancesData(final Main plugin) {
        this.plugin = plugin;
        this.savedefaultcfg();
    }
    ...
    public void reloadcfg() {
        if (this.cfgfile == null) {
            this.cfgfile = new File(this.plugin.getDataFolder(), "VictoryDances.yml");
        }
        this.datacfg = YamlConfiguration.loadConfiguration(this.cfgfile);
        final InputStream defaultStream = this.plugin.getResource("VictoryDances.yml");
    ...
    public void savedefaultcfg() {
        ...
        if (!this.cfgfile.exists()) {
            this.plugin.saveResource("VictoryDances.yml", false);
        }
    }
}
