...
public class ShopKeepersData
{
    private final Main plugin;
    private FileConfiguration datacfg;
    private File cfgfile;
    
    public ShopKeepersData(final Main plugin) {
        this.plugin = plugin;
        this.savedefaultcfg();
    }
    ...
    public void reloadcfg() {
        if (this.cfgfile == null) {
            this.cfgfile = new File(this.plugin.getDataFolder(), "ShopKeeperSkins.yml");
        }
        this.datacfg = YamlConfiguration.loadConfiguration(this.cfgfile);
        final InputStream defaultStream = this.plugin.getResource("ShopKeeperSkins.yml");
    ...
    public void savedefaultcfg() {
        ...
        if (!this.cfgfile.exists()) {
            this.plugin.saveResource("ShopKeeperSkins.yml", false);
        }
    }
}
