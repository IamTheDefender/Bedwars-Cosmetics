...
public class woodSkinsGUI extends HInventory {


    String title = "Wood Skins";
    String loc = "WoodSkins";
    String perm = "woodskin";
    FileConfiguration config = util.plugin().woodskindata.getConfig();
