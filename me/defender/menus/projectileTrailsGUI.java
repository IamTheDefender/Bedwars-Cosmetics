...
public class projectileTrailsGUI extends HInventory {



    String title = "Projectile Trails";
    String loc = "ProjectileTrails";
    String perm = "pt";
    FileConfiguration config = util.plugin().pedata.getConfig();

    public projectileTrailsGUI() {
        super("none", "Projectile Trails", 6, InventoryType.CHEST);
    }
