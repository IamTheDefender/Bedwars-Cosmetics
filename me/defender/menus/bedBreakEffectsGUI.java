...
public class bedBreakEffectsGUI extends HInventory {

    String title = "Bed Break Effects";
    String loc = "BedBreakEffects";
    String perm = "bedbreakeffect";
    FileConfiguration config = util.plugin().bbedata.getConfig();

    public bedBreakEffectsGUI() {
        super("none", "Bed Break Effects", 6, InventoryType.CHEST);
    }
