...
public class victoryDanceGUI extends HInventory {


    String title = "Victory Dances";
    String loc = "VictoryDances";
    String perm = "VictoryDances";
     FileConfiguration config = util.plugin().vdconf.getConfig();

    public victoryDanceGUI() {
        super("none", "Victory Dances", 6, InventoryType.CHEST);
    }
