...
public class deathCries extends HInventory {
    String title = "Death Cries";
    String loc = "DeathCries";
    String perm = "DeathCries";
    FileConfiguration config = util.plugin().dcdata.getConfig();

    public deathCries() {
        super("none", "Death Cries", 6, InventoryType.CHEST);
    }
