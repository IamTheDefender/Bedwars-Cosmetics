...
public class shopKeeperGUI extends HInventory {

    String title = "ShopKeeper Skins";
    String loc = "ShopKeeperSkins";
        String loc1 = "ShopKeeperSkin";
    String perm = "ShopKeeperSkins";
    FileConfiguration config = util.plugin().shopkeeperdata.getConfig();

    public shopKeeperGUI() {
        super("none", "ShopKeeper Skins", 6, InventoryType.CHEST);
    }
